...
namespace EstudiosBiblicos.ViewModels
{
    public class VML7 : VMBase
    {
        ...
        public VML7(INavigation navService) : base(navService)
        {
        }
        ...
        public async Task Load()
        {
            ...
            var listado = App.Database.GetL7();
            if (listado != null)
            {
                this.Cursos = listado;
                ...
                if (FechaInicio == _fech)
                {
                    ...
                    App.Database.InsertarL7(_Cursos);
                }
        ...
        private Leccion7Sel _Cursos;
        public Leccion7Sel Cursos
        {
            get { return _Cursos; }
            set
            {
