...
namespace EstudiosBiblicos.ViewModels
{
    public class VML3 : VMBase
    {
        ...
        int _Correctas;
        int _cantidadpreguntas = 8;
        public VML3(INavigation navService) : base(navService)
        {
        }
        ...
        public async Task Load()
        {
            ...
            var listado = App.Database.GetL3();
            if (listado != null)
            {
                this.Cursos = listado;
                ...
                if (FechaInicio == _fech)
                {
                    ...
                    App.Database.InsertarL3(_Cursos);
                }
        ...
        private Leccion3Sel _Cursos;
        public Leccion3Sel Cursos
        {
            get { return _Cursos; }
            set
            {
