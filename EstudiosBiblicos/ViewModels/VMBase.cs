...
namespace EstudiosBiblicos.ViewModels
{
    ...
    {
        public INavigation VMNavigation { get; set; }

        public static object objlock { get; set; }

        public event PropertyChangedEventHandler PropertyChanged;

        public VMBase(INavigation navService)
        {
            if (VMBase.objlock == null) VMBase.objlock = new object();

            VMNavigation = navService;
            //App.CambioConexion += App_CambioConexion;
        }
