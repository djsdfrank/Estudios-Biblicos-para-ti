...
namespace EstudiosBiblicos.ViewModels
{
    public class VML1 : VMBase
    {
        ...
        int _Correctas;
        public VML1(INavigation navService) : base(navService)
        {
        }
        ...
        public async Task Load()
        {
            ...
            var listado = App.Database.GetL1();
            if (listado != null)
            {
                this.Cursos = listado;
                ...
                if (FechaInicio == _fech)
                {
                    ...
                    App.Database.InsertarL1(_Cursos);
                }
        ...
        private Leccion1Sel _Cursos;
        public Leccion1Sel Cursos
        {
            get { return _Cursos; }
            set
            {
        ...
        public decimal Progreso
        {
            get
            {
                var pct = (decimal)Seleccionadas / 7;
                if (pct == 1)
                {
                    if (FechaFin == _fech)
                    {
                    ...
                    var inc = 7 - Correctas;
                    var _pct = Decimal.ToInt32(((decimal)Correctas / 7) *100);
                    App.Tiempo = HorasTrabajadas;
                    App.Puntos  = Correctas.ToString() + "/7";
                    App.Preguntas = "7";
                ...
                if (Seleccionadas == 0)
                    ...
                    return (decimal)Seleccionadas / 7;                    
            }
        }
        public bool S1
        {
