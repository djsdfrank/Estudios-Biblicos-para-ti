...
namespace EstudiosBiblicos.ViewModels
{
    public class VML5 : VMBase
    {
        ...
        public VML5(INavigation navService) : base(navService)
        {
        }
        ...
        public async Task Load()
        {
            ...
            var listado = App.Database.GetL5();
            if (listado != null)
            {
                this.Cursos = listado;
                ...
                if (FechaInicio == _fech)
                {
                    ...
                    App.Database.InsertarL5(_Cursos);
                }
        ...
        private Leccion5Sel _Cursos;
        public Leccion5Sel Cursos
        {
            get { return _Cursos; }
            set
            {
