...
namespace EstudiosBiblicos.ViewModels
{
    public class VML2 : VMBase
    {
        ...
        int _Correctas;
        int _cantidadpreguntas = 9;
        public VML2(INavigation navService) : base(navService)
        {
        }
        ...
        public async Task Load()
        {
            ...
            var listado = App.Database.GetL2();
            if (listado != null)
            {
                this.Cursos = listado;
                ...
                if (FechaInicio == _fech)
                {
                    ...
                    App.Database.InsertarL2(_Cursos);
                }
        ...
        private Leccion2Sel _Cursos;
        public Leccion2Sel Cursos
        {
            get { return _Cursos; }
            set
            {
