...
namespace EstudiosBiblicos.ViewModels
{
    public class VML6 : VMBase
    {
        ...
        public VML6(INavigation navService) : base(navService)
        {
        }
        ...
        public async Task Load()
        {
            ...
            var listado = App.Database.GetL6();
            if (listado != null)
            {
                this.Cursos = listado;
                ...
                if (FechaInicio == _fech)
                {
                    ...
                    App.Database.InsertarL6(_Cursos);
                }
        ...
        private Leccion6Sel _Cursos;
        public Leccion6Sel Cursos
        {
            get { return _Cursos; }
            set
            {
        ...
        public bool S28
        {
            ...
            set
            {
                ...
                if (_S28)
                {
                    _S29 = false;
                    _S30 = false;
                    OnPropertyChanged("S28");
                    OnPropertyChanged("S29");
                    OnPropertyChanged("S30");
                    OnPropertyChanged("Seleccionadas");
                    OnPropertyChanged("Progreso");
                }
                Cursos.S28 = _S28;
