...
namespace EstudiosBiblicos.ViewModels
{
    public class VML4 : VMBase
    {
        ...
        public VML4(INavigation navService) : base(navService)
        {
        }
        ...
        public async Task Load()
        {
            ...
            var listado = App.Database.GetL4();
            if (listado != null)
            {
                this.Cursos = listado;
                ...
                if (FechaInicio == _fech)
                {
                    ...
                    App.Database.InsertarL4(_Cursos);
                }
        ...
        private Leccion4Sel _Cursos;
        public Leccion4Sel Cursos
        {
            get { return _Cursos; }
            set
            {
