...
{
    public partial class WCursoSelMult3 : ContentPage
    {
        ViewCell lastCell;
        public WCursoSelMult3()
        {
            InitializeComponent();
            NavigationPage.SetHasNavigationBar(this, false);
            this.BindingContext = new VML3(Navigation);
        ...
        {
            await ((VML3)this.BindingContext).Load();
        }
        ...
        void btnfinalizar_Clicked(System.Object sender, System.EventArgs e)
        {
            ...
            Device.BeginInvokeOnMainThread(() =>
            {
                try
                {
                    ((VML3)this.BindingContext).Finalizar();
