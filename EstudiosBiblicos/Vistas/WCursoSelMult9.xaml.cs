...
{
    public partial class WCursoSelMult9 : ContentPage
    {
        ViewCell lastCell;
        public WCursoSelMult9()
        {
            InitializeComponent();
            NavigationPage.SetHasNavigationBar(this, false);
            this.BindingContext = new VML8(Navigation);
        ...
        {
            await ((VML8)this.BindingContext).Load();
        }
        ...
        void btnfinalizar_Clicked(System.Object sender, System.EventArgs e)
        {
            ...
            Device.BeginInvokeOnMainThread(() =>
            {
                try
                {
                    ((VML8)this.BindingContext).Finalizar();
