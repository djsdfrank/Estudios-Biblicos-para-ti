...
{
    public partial class WCursoSelMult5 : ContentPage
    {
        ViewCell lastCell;
        public WCursoSelMult5()
        {
            InitializeComponent();
            NavigationPage.SetHasNavigationBar(this, false);
            this.BindingContext = new VML5(Navigation);
        ...
        {
            await ((VML5)this.BindingContext).Load();
        }
        ...
        void btnfinalizar_Clicked(System.Object sender, System.EventArgs e)
        {
            ...
            Device.BeginInvokeOnMainThread(() =>
            {
                try
                {
                    ((VML5)this.BindingContext).Finalizar();
