...
{
    public partial class WCursoSelMult7 : ContentPage
    {
        ViewCell lastCell;
        public WCursoSelMult7()
        {
            InitializeComponent();
            NavigationPage.SetHasNavigationBar(this, false);
            this.BindingContext = new VML7(Navigation);
        ...
        {
            await ((VML7)this.BindingContext).Load();
        }
        ...
        void btnfinalizar_Clicked(System.Object sender, System.EventArgs e)
        {
            ...
            Device.BeginInvokeOnMainThread(() =>
            {
                try
                {
                    ((VML7)this.BindingContext).Finalizar();
