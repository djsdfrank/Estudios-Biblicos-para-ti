...
{
    public partial class WCursoSelMult4 : ContentPage
    {
        ViewCell lastCell;
        public WCursoSelMult4()
        {
            InitializeComponent();
            NavigationPage.SetHasNavigationBar(this, false);
            this.BindingContext = new VML4(Navigation);
        ...
        {
            await ((VML4)this.BindingContext).Load();
        }
        ...
        void btnfinalizar_Clicked(System.Object sender, System.EventArgs e)
        {
            ...
            Device.BeginInvokeOnMainThread(() =>
            {
                try
                {
                    ((VML4)this.BindingContext).Finalizar();
