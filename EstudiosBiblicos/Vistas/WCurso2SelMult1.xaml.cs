...
{
    public partial class WCurso2SelMult1 : ContentPage
    {
        ViewCell lastCell;
        public WCurso2SelMult1()
        {
            InitializeComponent();
            NavigationPage.SetHasNavigationBar(this, false);
            this.BindingContext = new VML9(Navigation);
        ...
        {
            await ((VML9)this.BindingContext).Load();
        }
        ...
        void Textobiblico(int Id)
        {
            Device.BeginInvokeOnMainThread(() =>
            {
                try
                {
                    PopupNavigation.Instance.PushAsync(new Vistas.PopUpTextoBiblico(Id+10));
                }
                catch (Exception ex)
                {
        ...
        void btnfinalizar_Clicked(System.Object sender, System.EventArgs e)
        {
            ...
            Device.BeginInvokeOnMainThread(() =>
            {
                try
                {
                    ((VML9)this.BindingContext).Finalizar();
