...
{
    public partial class WCursoSelMult2 : ContentPage
    {
        ViewCell lastCell;
        public WCursoSelMult2()
        {
            InitializeComponent();
            NavigationPage.SetHasNavigationBar(this, false);
            this.BindingContext = new VML2(Navigation);
        ...
        {
            await ((VML2)this.BindingContext).Load();
        }
        ...
        void btnfinalizar_Clicked(System.Object sender, System.EventArgs e)
        {
            ...
            Device.BeginInvokeOnMainThread(() =>
            {
                try
                {
                    ((VML2)this.BindingContext).Finalizar();
