...
{
    public partial class WCursoSelMult : ContentPage
    {
        ViewCell lastCell;
        public WCursoSelMult()
        {
            InitializeComponent();
            NavigationPage.SetHasNavigationBar(this, false);
            this.BindingContext = new VML1(Navigation);
        ...
        {
            await ((VML1)this.BindingContext).Load();
        }
        ...
        void btnfinalizar_Clicked(System.Object sender, System.EventArgs e)
        {
            ...
            Device.BeginInvokeOnMainThread(() =>
            {
                try
                {
                    ((VML1)this.BindingContext).Finalizar();
